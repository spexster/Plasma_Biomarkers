#31_advanced_tcell_aging_analysis.R
# WebGestalt
# GSEA
...
indir  <- file.path(PROJ, "results/edgeR")
outdir <- file.path(PROJ, "results/webgestalt")
dir.create(outdir, showWarnings = FALSE, recursive = TRUE)

## Choose cell type tag (matches your DE file suffix)
cell <- "CD4_positive_alpha_beta_T_cell_edgeR"   # <-- change for each T-cell type
...
de_csv <- file.path(indir, paste0("DE_age_effect_", cell, ".csv"))
...
################################################################################
# HOW TO RUN
# source("~/31_advanced_tcell_aging_analysis.R")
################################################################################
